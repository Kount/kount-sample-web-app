...
<div class="row">
    ...
    <div class="col-md-6 explanation" style="min-height: 460px">
      ...
      <form class="pricingForm" action="shipping.php" method="POST">
        ...
        <div class="checkoutBtn">
          <button id="proceed" class="btn btn-primary" formaction="shipping.php" role="button">Proceed to Checkout
          </button>
        </div>
      </form>
  ...
  <img width="1" height="1" src='https://bta.kaptcha.com/collect/sdk?m=<?=$merchantId?>&s=<?=$session?>'/>
